...
# Example extraction prediction result (use full list of predictions)
PREDICTIONS = [
    {"label": "line_date", "start": 12, "end": 18, "text": "1/2/2021"},
    {"label": "line_value", "start": 20, "end": 23, "text": "$12"},
]
# Example OCR Token retrieved from workflow result with
# Workflow.get_ondoc_ocr_from_etl_url
OCR_TOKENS = [
    {
        "page_num": 0,
        "position": {
...
# adds "row_number", page_num, and bounding box metadata to every line_item_fields
